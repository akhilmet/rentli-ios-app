...
1. **Clone the repository**
   ```bash
   git clone https://github.com/akhilmet/rentli.git
   cd rentli
   ```

2. **Open in Xcode**
   ```bash
   open Rentli.xcodeproj
   ```
...
```bash
feat: add campus rentals home screen
...
- **Documentation**: [docs.rentli.app](https://docs.rentli.app)
- **GitHub Repository**: [github.com/akhilmet/rentli](https://github.com/akhilmet/rentli)
- **Bug Reports**: [GitHub Issues](https://github.com/akhilmet/rentli/issues)
